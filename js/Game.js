class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 250, y: height - 1200, image: obstacle2Image },
      { x: width / 2 + 150, y: height - 1500, image: obstacle2Image },
      { x: width / 2 - 280, y: height - 3200, image: obstacle2Image },
     
      { x: width / 2 - 250, y: height - 4600, image: obstacle2Image },
      { x: width / 2, y: height - 5100, image: obstacle2Image },
    ];
